...
\u518D\u5EA6\u8A8D\u8A3C\u3057\u3066\u304F\u3060\u3055\u3044\u3002`,size:"sm",color:n.COLORS.TEXT_SECONDARY,wrap:!0,align:"center",margin:"lg"}],paddingAll:"xl"},footer:{type:"box",layout:"vertical",contents:[{type:"button",action:{type:"uri",label:"\u518D\u8A8D\u8A3C\u3059\u308B",uri:e+(e.includes("?")?"&":"?")+"openExternalBrowser=1"},style:"primary",color:n.COLORS.GOOGLE_BLUE}],paddingAll:"lg"}}});var oe=(e,t,o)=>{let r=w(t);if(!r){x(e,d.AUDIO_FETCH_FAILED);return}let s=z(r);if(!s){x(e,d.SPEECH_RECOGNITION_FAILED);return}let a=G(s);if(!a){x(e,d.EVENT_EXTRACTION_FAILED(s));return}let i=B(o,a);if(i.success&&i.eventId){let l=K(i.eventId),c=j(a,l);u(e,c)}else if(i.requiresReauth){let l=y(o),c=te(l);u(e,c)}else x(e,d.CALENDAR_CREATION_FAILED)};var b=e=>{let t=Q();u(e,t)};var S=(e,t)=>{let o=X(t),r=V(o);u(e,r)};var N=(e,t)=>{let o=q(t),r=W(o);u(e,r)};var L=(e,t)=>{A(t),x(e,`\u30ED\u30B0\u30A2\u30A6\u30C8\u3057\u307E\u3057\u305F\u3002
\u518D\u5EA6\u5229\u7528\u3059\u308B\u5834\u5408\u306F\u3001\u8A8D\u8A3C\u304C\u5FC5\u8981\u3067\u3059\u3002`)};var T=e=>{x(e,d.REQUEST_AUDIO)};var re=(e,t)=>{let o=y(t,!0),r=ee(o);u(e,r)};var ne=e=>{let t=e.replyToken,o=_e(e);if(!o){g("processLineEvent","userId\u3092\u53D6\u5F97\u3067\u304D\u307E\u305B\u3093\u3067\u3057\u305F"),T(t);return}if(He(e)){m("processLineEvent","follow\u30A4\u30D9\u30F3\u30C8\u3092\u53D7\u4FE1\u3057\u307E\u3057\u305F");return}if(!P(o)){re(t,o);return}we(e)?oe(t,e.message.id,o):Ue(e)?Me(t,e.message.text,o):$e(e)?Ye(t,e.postback.data,o):T(t)},_e=e=>e.source?.userId,Me=(e,t,o)=>{let r=t.trim();Ge(r)?b(e):ze(r)?S(e,o):ke(r)?N(e,o):Pe(r)?L(e,o):T(e)},we=e=>e.type==="message"&&e.message.type==="audio",Ue=e=>e.type==="message"&&e.message.type==="text",ke=e=>n.COMMANDS.TODAY.some(t=>e.includes(t)),ze=e=>n.COMMANDS.WEEK.some(t=>e.includes(t)),Ge=e=>n.COMMANDS.HELP.some(t=>e.includes(t)),Pe=e=>n.COMMANDS.LOGOUT.some(t=>e.includes(t)),$e=e=>e.type==="postback"&&e.postback,He=e=>e.type==="follow",Ye=(e,t,o)=>{let r=t.match(/action=([^&]+)/);switch(r?r[1]:null){case"logout":L(e,o);break;case"today":N(e,o);break;case"week":S(e,o);break;case"help":b(e);break;default:T(e)}},m=(e,t)=>{console.log(`${e}: ${t}`)},g=(e,t)=>{console.log(`${e}\u30A8\u30E9\u30FC: ${t}`)};var F=e=>{let t=$(e);return t.success?HtmlService.createHtmlOutput(Be()):HtmlService.createHtmlOutput(qe(t.error||"\u4E0D\u660E\u306A\u30A8\u30E9\u30FC"))},Be=()=>`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
