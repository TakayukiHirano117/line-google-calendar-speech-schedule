 ...
 * @returns {Object|null} イベントデータ {title, startTime, endTime, description}
 */
export const extractCalendarEventFromText = (transcribedText) => {
 ...
 * @returns {string}
 */
export const buildEventExtractionPrompt = (transcribedText) => {
 ...
 * @returns {string}
 */
export const formatTodayForPrompt = () => {
 ...
 * @returns {string}
 */
export const formatCurrentTimeForPrompt = () => {
  const now = new Date();
 ...
 * @returns {Object}
 */
export const buildGeminiRequestBody = (prompt) => {
  return {
    contents: [
      {
        parts: [
 ...
 * @returns {string}
 */
export const buildGeminiApiEndpoint = (apiKey) => {
 ...
 * @returns {Object|null}
 */
export const parseGeminiResponseToEventData = (responseData) => {
  try {
 ...
 * @returns {boolean}
 */
export const isValidEventData = (eventData) => {
